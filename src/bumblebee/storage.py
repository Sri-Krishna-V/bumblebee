...
def _s3_options() -> dict[str, Any]:
    """Target AWS S3 by default; S3-compatible endpoints via BUMBLEBEE_S3_* / AWS_* env.

    Credentials are read by s3fs from the standard ``AWS_ACCESS_KEY_ID`` /
    ``AWS_SECRET_ACCESS_KEY`` variables.
    """
    endpoint = os.environ.get("BUMBLEBEE_S3_ENDPOINT_URL") or os.environ.get("AWS_ENDPOINT_URL_S3")
    region = os.environ.get("BUMBLEBEE_S3_REGION") or os.environ.get("AWS_REGION")
...
def _azure_options() -> dict[str, Any]:
    ...
    Accepts a connection string, a full SAS URL in ``BUMBLEBEE_AZURE_SAS_URL`` /
    ...
    """
    connection_string = os.environ.get("BUMBLEBEE_AZURE_CONNECTION_STRING") or os.environ.get(
    ...
    account_name = os.environ.get("BUMBLEBEE_AZURE_ACCOUNT_NAME") or os.environ.get("AZURE_STORAGE_ACCOUNT")
    sas_url = (
        os.environ.get("BUMBLEBEE_AZURE_SAS_URL")
        or os.environ.get("AZURE_STORAGE_SAS_URL")
        or os.environ.get("AZURE_BLOB_SAS_URL")
    )
    sas_token = os.environ.get("BUMBLEBEE_AZURE_SAS_TOKEN") or os.environ.get("AZURE_STORAGE_SAS_TOKEN")
