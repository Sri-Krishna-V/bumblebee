...
Both the PyTorch detector (:mod:`bumblebee.layout.torch`) and the ONNX/TensorRT
detector (:mod:`bumblebee.layout.onnx`) target PP-DocLayoutV3 and so share the
...
from bumblebee.models import Region, Task
